    ...
    <path d="M12 2a10 10 0 0 0-8.72 14.9L2 22l5.25-1.25A10 10 0 1 0 12 2Zm5.16 14.34c-.21.6-1.2 1.11-1.66 1.18-.43.06-.97.09-1.56-.1-.36-.12-.83-.27-1.43-.53-2.52-1.09-4.16-3.63-4.29-3.8-.13-.17-1.02-1.36-1.02-2.6 0-1.24.65-1.85.88-2.1.23-.25.5-.31.67-.31h.48c.15 0 .35-.06.54.39.21.5.72 1.73.78 1.86.06.12.1.27.02.44-.08.17-.12.27-.25.41-.12.14-.26.31-.37.42-.12.12-.24.25-.1.49.13.23.59.97 1.27 1.57.87.77 1.6 1.01 1.83 1.12.23.12.37.1.5-.06.17-.21.67-.78.85-1.05.17-.27.35-.23.58-.14.23.08 1.47.69 1.72.81.25.12.42.18.48.27.06.08.06.5-.15 1.1Z" />
          ...
          <nav className="mb-16 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">Tutorías que sí se entienden</p>
              </div>
            </div>
            <a
              href="#contacto"
          ...
          <div className="grid items-center gap-14 lg:grid-cols-2">
            <div>
              ...
              <h1 className="max-w-2xl text-5xl font-black leading-tight tracking-tight sm:text-6xl">
                Entender <span className="text-emerald-500">matemáticas</span>, física y química ya no tiene que sentirse imposible.
              </h1>
              <p className="mt-6 max-w-xl text-lg leading-8 text-slate-600">
                En BrainLab ayudamos a estudiantes de secundaria y bachiller a reforzar temas, recuperar confianza y aprender de verdad con clases claras, directas y adaptadas a su ritmo.
              </p>
            ...
            <div className="relative">
              ...
              <div className="relative rounded-[2rem] border border-slate-200 bg-white p-6 shadow-2xl">
                <div className="rounded-[1.5rem] bg-slate-900 p-8 text-white">
                  <p className="text-sm uppercase tracking-[0.3em] text-emerald-300">BrainLab</p>
                ...
                <div className="mt-6 grid gap-4 sm:grid-cols-2">
                  <div className="rounded-2xl bg-emerald-50 p-5">
                    <p className="text-sm font-semibold text-emerald-700">Ideal para</p>
                    <p className="mt-2 text-slate-700">Estudiantes que quieren reforzar, nivelarse o prepararse mejor para exámenes.</p>
                  </div>
                  <div className="rounded-2xl bg-sky-50 p-5">
                    <p className="text-sm font-semibold text-sky-700">Modalidad</p>
                    <p className="mt-2 text-slate-700">Presencial en David, Chiriquí, y virtual para estudiantes de otras zonas.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="servicios" className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        <div className="max-w-2xl">
          <p className="text-sm font-bold uppercase tracking-[0.25em] text-emerald-500">Servicios</p>
          <h2 className="mt-3 text-4xl font-black tracking-tight">Apoyo académico pensado para que el estudiante avance de verdad.</h2>
          <p className="mt-4 text-lg text-slate-600">
            Desde temas básicos hasta contenidos más exigentes, cada clase se adapta a la necesidad real del estudiante.
          </p>
        </div>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          {[
            ...
            <div key={card.title} className="rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
      ...
      <section className="bg-slate-900 text-white">
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            <div>
              <p className="text-sm font-bold uppercase tracking-[0.25em] text-emerald-300">Por qué BrainLab</p>
              <h2 className="mt-3 text-4xl font-black tracking-tight">Menos frustración. Más claridad.</h2>
              <p className="mt-4 max-w-xl text-lg text-slate-300">
                Aquí el objetivo no es llenar al estudiante de información, sino explicarle bien, detectar qué le está frenando y ayudarlo a avanzar con seguridad.
              </p>
            </div>
      ...
      <section id="contacto" className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-[2rem] bg-white p-8 shadow-xl ring-1 ring-slate-200">
            <p className="text-sm font-bold uppercase tracking-[0.25em] text-emerald-500">Contacto</p>
            <h2 className="mt-3 text-4xl font-black tracking-tight">Reserva tu clase</h2>
            <p className="mt-4 max-w-xl text-lg text-slate-600">
              Escríbenos y cuéntanos qué materia necesitas reforzar. Te orientamos según el nivel y el objetivo del estudiante.
            </p>
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
          ...
          <div className="rounded-[2rem] bg-gradient-to-br from-emerald-500 to-sky-500 p-8 text-white shadow-2xl">
            ...
            <p className="mt-4 text-white/90">
              Presencial o virtual. Para secundaria, bachiller y también refuerzo básico para niños.
            </p>
            <a
        ...
        <div className="grid gap-10 lg:grid-cols-3">
          <div className="rounded-[2rem] bg-white p-8 shadow-xl ring-1 ring-slate-200">
            ...
            <p className="mt-4 text-slate-600 leading-7">
              BrainLab es un espacio de tutorías creado para estudiantes que necesitan algo más que una explicación rápida. Nacimos con la idea de enseñar de forma clara, directa y sin complicaciones, adaptándonos al ritmo de cada estudiante.
              
              Nuestro enfoque no es solo que el estudiante pase la materia, sino que realmente entienda lo que está haciendo y gane confianza en el proceso.
            </p>
          </div>
          ...
          <div className="rounded-[2rem] bg-white p-8 shadow-xl ring-1 ring-slate-200">
            ...
            <p className="mt-4 text-slate-600 leading-7">
              Lograr que cada estudiante comprenda los temas desde la base, eliminando la frustración y fortaleciendo su seguridad académica.
              
              Buscamos que el aprendizaje sea progresivo, real y sostenible, para que puedan enfrentar exámenes y clases con mayor tranquilidad y dominio.
            </p>
          </div>
          ...
          <div className="rounded-[2rem] bg-white p-8 shadow-xl ring-1 ring-slate-200">
            ...
            <p className="mt-4 text-slate-600 leading-7">
              Primero identificamos en qué punto está el estudiante y qué temas le generan dificultad. A partir de ahí, organizamos las clases de forma progresiva, comenzando desde lo necesario para construir una base sólida.
              
              Cada sesión se enfoca en explicar, practicar y reforzar, asegurando que el estudiante entienda antes de avanzar.
            </p>
          </div>
        </div>
      </section>
